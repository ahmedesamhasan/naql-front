...
import srImage from "../../assets/images/sr.webp";
import EyeIcon from '../../icons/EyeIcon';
import EyeOffIcon from '../../icons/EyeOffIcon';
import { LightTextField } from '../../mui/fields/LightTextField';
import type { CurrencyTypes } from '../../types/components';
import type { AllFormsTypes } from '../../types/forms';

const Currency = <T extends AllFormsTypes>({ formik, name, disabled, label, type, showPassword, icon, note, placeholder, error, value, ac, helperText, amount, change, togglePassword, handleMouseDownPassword }: CurrencyTypes<T>) => {
    ...
    return (
        <Box className={`grid justify-stretch items-center gap-1`}>
            ...
            >
                ...
                />
                <Box
                    className={`bg-primary py-1 px-4 flex justify-center items-center h-full`}
                >
                    <img
                        src={srImage}
                        alt={"sr"}
